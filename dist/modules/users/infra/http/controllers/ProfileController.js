...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var user_id, _a, name, email, old_password, password, updateProfile, user, userFormat, parsedUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user_id = request.user.id;
                        _a = request.body, name = _a.name, email = _a.email, old_password = _a.old_password, password = _a.password;
                        updateProfile = tsyringe_1.container.resolve(UpdateUserService_1.default);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, response.json(parsedUser)];
                }
            });
        });
    };
