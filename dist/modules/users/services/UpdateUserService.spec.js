...
describe('UpdateUser', function () {
    beforeEach(function () {
        ...
        updateUserService = new UpdateUserService_1.default(fakeUsersRepository, fakeHashProvider);
    });
    ...
    it('should not be able update from non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(updateUserService.execute({
